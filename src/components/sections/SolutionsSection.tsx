...
const strengths = [
  {
    ...
    description: '公式NetSuiteソリューションプロバイダーとして、SAP ECC6.0、OBIC7、スクラッチ基幹システムからの移行実績があります。製造業、商社、流通、小売、IT、出版、化粧品、食品など幅広い業種に対応しています。東証プライム・スタンダード上場企業への導入実績も多数あります。',
    icon: (
  ...
  },
  {
    ...
    description: 'NetSuiteの「OneWorld」機能を活かし、シンガポール、中国、香港、オーストラリアなど、海外拠点と本社を一元管理します。多通貨・多言語・IFRS対応を含むグローバル経営の可視化と統制強化を実現します。多国籍企業のために、幅広い言語で導入プロジェクトを推進しています。',
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
  ...
  },
  {
    ...
    description: '経営戦略とシステム基盤の両側面から、企業の成長を支援します。戦略的なERP導入を、経営視点で実現します。',
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
